...
public final class LimitedSizeTieredCompactionStrategyOptions
{
    protected static final long DEFAULT_MIN_SSTABLE_SIZE = 50L * 1024L * 1024L;
    protected static final double DEFAULT_BUCKET_LOW = 0.5;
    protected static final double DEFAULT_BUCKET_HIGH = 1.5;
    protected static final long DEFAULT_SSTABLE_SIZE_OPTION = 500L * 1024L * 1024L;
    ...
    public LimitedSizeTieredCompactionStrategyOptions(Map<String, String> options)
    {
        ...
        targetSSTableSize = optionValue == null ? DEFAULT_SSTABLE_SIZE_OPTION : Long.parseLong(optionValue) * 1024L * 1024L;
    }

    public LimitedSizeTieredCompactionStrategyOptions()
    {
    ...
    public static Map<String, String> validateOptions(Map<String, String> options, Map<String, String> uncheckedOptions) throws ConfigurationException
    {
        ...
        try
        {
            long targetSSTableSize = optionValue == null ? DEFAULT_SSTABLE_SIZE_OPTION : Long.parseLong(optionValue);
            if (targetSSTableSize < 0)
            {
                throw new ConfigurationException(String.format("%s must be non negative: %d", SSTABLE_SIZE_OPTION, targetSSTableSize));
            }
        }
        catch (NumberFormatException e)
        {
