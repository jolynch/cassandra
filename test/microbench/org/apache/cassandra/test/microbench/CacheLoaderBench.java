...
public class CacheLoaderBench extends CQLTester
{
    ...
    private List<ColumnFamilyStore> columnFamilyStores;
    ...
    public void setup() throws Throwable
    {
        ...
        table1 = createTable(keyspace, "CREATE TABLE %s (key text PRIMARY KEY, val text)");
        table2 = createTable(keyspace, "CREATE TABLE %s (key text PRIMARY KEY, val text)");
        ...
        columnFamilyStores = new ArrayList<>(2);
