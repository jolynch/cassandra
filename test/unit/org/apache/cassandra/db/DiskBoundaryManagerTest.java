...
public class DiskBoundaryManagerTest extends CQLTester
{
    ...
    public void updateTokensTest() throws UnknownHostException
    {
        ...
        StorageService.instance.getTokenMetadata().updateNormalTokens(RandomTokenProvider.getRandomTokens(StorageService.instance.getTokenMetadata(), 10), InetAddressAndPort.getByName("127.0.0.10"));
