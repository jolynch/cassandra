...
public class DynamicEndpointSnitchTest
{
    ...
    public void testReceiveTiming() throws InterruptedException, IOException, ConfigurationException
    {
        ...
        assertEquals(dsnitch.dumpTimings(host1.getHostAddress(false)), Arrays.asList(2.0, 3.0));
        ...
        dsnitch.receiveTiming(host1, 3, LatencyUsableForSnitch.YES);
        dsnitch.receiveTiming(host1, 4, LatencyUsableForSnitch.MAYBE);
        assertEquals(dsnitch.dumpTimings(host1.getHostAddress(false)), Arrays.asList(1.0, 2.0, 3.0));
        ...
        dsnitch.receiveTiming(host1, 4, LatencyUsableForSnitch.MAYBE);
        assertEquals(dsnitch.dumpTimings(host1.getHostAddress(false)), Arrays.asList(1.0, 2.0));
    }
}
